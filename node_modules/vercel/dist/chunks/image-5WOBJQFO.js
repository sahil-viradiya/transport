...
async function image(client, argv, telemetry) {
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-KIAXSLDB.js")).default(client, args, telemetry);
    case "inspect":
      return (await import("./inspect-7PJE37AJ.js")).default(client, args, telemetry);
    case "rm":
      return (await import("./rm-KGRSF2OY.js")).default(client, args, telemetry);
    default:
