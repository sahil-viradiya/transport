      ...
      builder: (context, constraints) {
        ...
        return Container(
          ...
          padding: EdgeInsets.symmetric(
              horizontal: isVeryNarrow ? 10 : 20, vertical: 10),
          child: Row(
            children: [
              IconButton(
              ...
              Expanded(
                child: Obx(() {
                  final label = _navItems
                      .firstWhere(
                          (e) => e.$3 == controller.currentTabIndex.value,
              ...
              PopupMenuButton<String>(
                ...
                child: Container(
                  padding: EdgeInsets.symmetric(
                      horizontal: isVeryNarrow ? 8 : 12, vertical: 8),
                  decoration: BoxDecoration(
                ...
                const Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      SizedBox(width: 48), // Align with more options menu
                    ],
                  ),
                ),
  ...
  Widget _buildComplianceCheckButton(BuildContext context, String label,
    ...
    Widget card = Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color:
              present ? activeIconColor.withValues(alpha: 0.2) : Colors.transparent,
        ),
      ),
      child: Column(
        mainAxisSize: MainAxisSize.min,
